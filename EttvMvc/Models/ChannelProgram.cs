...
namespace EttvMvc.Models
{
    public class ChannelProgram
    {
        ...
        private static List<ChannelProgram> channelPrograms = new List<ChannelProgram>
        {
            new ChannelProgram{
                Id = 1,
                StartTime = new DateTime(2019, 5, 29, 11, 00, 00),
                EndTime = new DateTime(2019, 5, 29, 11, 20, 00),
            ...
            new ChannelProgram{
                Id = 2,
                StartTime = new DateTime(2019, 5, 29, 10, 34, 01),
                EndTime = new DateTime(2019, 5, 29, 11, 40, 00),
            ...
            new ChannelProgram{
                Id = 3,
                StartTime = new DateTime(2019, 5, 29, 11, 41, 01),
                EndTime = new DateTime(2019, 5, 29, 11, 59, 30),
