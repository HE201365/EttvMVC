...
namespace EttvMvc.Models
{
    public class ChannelProgram
    {
        ...
        private static List<ChannelProgram> channelPrograms = new List<ChannelProgram>
        {
            new ChannelProgram{
                Id = 1,
                StartTime = new DateTime(2019, 5, 30, 21, 20, 00),
                EndTime = new DateTime(2019, 5, 30, 21, 37, 00),
            ...
            new ChannelProgram{
                Id = 2,
                StartTime = new DateTime(2019, 5, 30, 21, 37, 01),
                EndTime = new DateTime(2019, 5, 30, 22, 45, 00),
            ...
            new ChannelProgram{
                Id = 3,
                StartTime = new DateTime(2019, 5, 30, 22, 45, 01),
                EndTime = new DateTime(2019, 5, 30, 22, 50, 30),
